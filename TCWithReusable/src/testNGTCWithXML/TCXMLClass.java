...
public class TCXMLClass extends ReUsable
{
	@Test//(priority=1)
	@Parameters({"uname","password"})
	public void Navigate_to_SFDC_TC1(String uname,String password)
	{
	...
	@Test(priority=2)
	@Parameters({"uname","password"})
	public void Login_to_SFDC_TC2(String uname,String password) throws InterruptedException
	{
	...
	@Test(priority=3)
	@Parameters({"uname","password"})
	public void Test_remember_checkbo_TC3(String uname,String password)
	{
	...
	@Test(priority=4)
	@Parameters({"uname"})
	public void Test_Forgot_Password_4a(String uname)
	{
		...
		EnterText(forgetUn, "Username for forgot", uname);
	...
	@Test(priority=5)
	@Parameters({"wrnguname","wrngpwd"})
	public void Validate_Login_Error_Message_4b(String wrnguname,String wrngpwd)
	{
		System.out.println("Welcome To TestCase4b");
		InitializeDriver();
		Launch("https://login.salesforce.com/");
		WebElement un = findElement(By.xpath("//input[@id='username']"), "User Name");
		EnterText(un,"User Name", wrnguname);
		WebElement pass = findElement(By.xpath("//input[@id='password']"), "Password");
		EnterText(pass,"Password", wrngpwd);
		WebElement Login = findElement(By.xpath("//input[@id='Login']"),"Login");
		click_On_Button(Login, "Login");
		WebElement ErrorMsg = findElement(By.xpath("//div[@id='error']"), "Error Message");
		System.out.println(ErrorMsg.getText());
...
//
	@Test(priority=7)
	@Parameters({"uname","password","EName","EAdd"})
	public void Select_MySetting_Dropdown_7(String uname,String password,String EName,String EAdd) throws InterruptedException
	{
	...
	@Test(priority=8)
	@Parameters({"uname","password"})
	public void Developers_Console_UserName_Dropdown_8(String uname,String password) throws InterruptedException
	{
	...
	@Test(priority=9)
	@Parameters({"uname","password"})
	public void Logout_UserName_Dropdown_9(String uname,String password) throws InterruptedException
	{
	...
	@Test(priority=10)
	@Parameters({"uname","password","AcName"})
	public void Create_an_Account_10(String uname,String password,String AcName) throws InterruptedException
	{
		...
		AccName.clear();
		EnterText(AccName, "Account Name", AcName);
